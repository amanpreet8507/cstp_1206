...
setTimeout(function(){
    console.log("Hey I am priniting after 5 seconds....");
...
let timer = setInterval(function(){
    console.log('Say Hi agter every 2 seconds');
}, 2000);
...
//************************************ 
//SETINTERVAL and SET TIMEOUT TOGETHER
//************************************ 
let timer2 = setInterval(() => {
    console.log('Hey how it is going');
